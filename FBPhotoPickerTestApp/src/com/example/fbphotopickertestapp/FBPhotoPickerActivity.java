...
public class FBPhotoPickerActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		params.putString(Constants.FB_FIELDS_PARAM,
				Constants.FB_PHOTO_ALBUM_FIELDS);
				...
				new Callback() {
					...
					public void onCompleted(Response response) {
						...
						if (response.getGraphObject() != null) {
							...
							try {
								JSONArray jsonFBAlbums = json.getJSONObject(
										"albums").getJSONArray("data");
...
//											.getString("cover_photo");
									...
									JSONArray jsonPhotos = jsonAlbum
									...
									for (int j = 0; j < jsonPhotos.length(); j++) {
										...
										fbPhoto.setId(jsonFBPhoto
												.getString("id"));
										fbPhoto.setUrl(jsonFBPhoto
												.getString("picture"));
										fbPhoto.setSource(jsonFBPhoto
												.getString("source"));
//										if (fbPhoto.getId()
//												.equals(coverImageId)) {
											fbAlbum.setCoverPhoto(fbPhoto
													.getUrl());
//										}
										...
										.setOnItemClickListener(new OnItemClickListener() {
											...
											public void onItemClick(
												...
												mPhotos = fbAlbums
														...
														.getPhotos();
												mPhotosGrid
														.setAdapter(new FBPhotoArrayAdapter(
																mContext, 0,
																mPhotos));
								...
								mPhotosGrid
										.setOnItemClickListener(new OnItemClickListener() {
											...
											public void onItemClick(
												...
												resultData.putExtra(PHOTO_ID,
														mPhotos.get(position)
																.getId());
												resultData.putExtra(PHOTO_URL,
														mPhotos.get(position)
																.getSource());
